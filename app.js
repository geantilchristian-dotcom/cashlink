...
let cfg = {
    ...
    contact_address:'', contact_email:'support@cashlink.cd',
    puissance_hash:'104.2 TH/s', cover_url:'', main_title:'MINAGE INDUSTRIEL',
    cert_price:30000,
    hero_title:'MINAGE INDUSTRIEL',
    hero_subtitle:'Le protocole CASHLINK v28.0 déploie une puissance de calcul décentralisée pour chaque utilisateur.',
    tagline:'', welcome_msg:'', alert_msg:'',
    about_text:'CashLink est le leader du minage numérique décentralisé.',
